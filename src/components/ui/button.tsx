...
const buttonVariants = cva(
  ...
  dark:bg-dark-primary dark:text-light-text
...
`,
                ...
                outline:
                    "hover:bg-light-primary dark:hover:bg-dark-primary dark:hover:text-light-text hover:text-dark-text border shadow-sm dark:border-input",
                secondary:
